...
import EnterSpecification from "./EnterSpecification";
        ...
        <div className="mt-8 px-4">
          <div className="flex flex-col justify-between lg:flex-row">
            <div className="mb-6 w-full  ltr:lg:mr-6 rtl:lg:ml-6">
              ...
              <div className="mt-4 flex items-center">
                <EnterSpecification {...{ specifications, setSpecifications }} />
              </div>
              <div className="mt-4 flex items-center">
                <AddCategory category={category} setCategory={setCategory} />
              </div>

              {!productId && (<div className="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-1">
                <SavePanel handleSave={handleAddProduct} text="Add Product" />
              </div>)}
                ...
                productId && (
                  <div className="mt-8">
                    ...
                    <div className="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-1">
                      <SavePanel handleSave={handleImageUpload} text="Save Details" />
                    </div>
                  </div>
                )
              }
